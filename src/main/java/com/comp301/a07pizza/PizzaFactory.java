...
public class PizzaFactory {
  public static Pizza makeCheesePizza(Pizza.Size size) {
    Pizza cheese =
        new PizzaImpl(size, Crust.HAND_TOSSED, Sauce.TOMATO, Cheese.BLEND, new Ingredient[0]);
    return cheese;
  }
  ...
  public static Pizza makeDailySpecialPizza() {
    ...
    toppings[1] = Topping.GREEN_PEPPER;
    Pizza dailySpecial =
        new PizzaImpl(Pizza.Size.MEDIUM, Crust.HAND_TOSSED, Sauce.TOMATO, Cheese.BLEND, toppings);
    return dailySpecial;
  }
}
